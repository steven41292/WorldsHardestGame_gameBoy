...
# NOTICE:  Steven Wojcio
################################################################################

# The name of your desired GBA game
# This should be a just a name i.e MyFirstGBAGame
# No SPACES AFTER THE NAME.
PROGNAME = WorldsHardestGBAGame

# The object files you want to compile into your program
# This should be a space (SPACE!) separated list of .o files
OFILES = GBAmain.o GBAlib.o hardestGamePic.o Level1.o Level2.o Level3.o difficultySelect.o win1.o win2.o deathFace.o

# The header files you have created.
# This is necessary to determine when to recompile for files.
# This should be a space (SPACE!) separated list of .h files
HFILES = GBAlib.h hardestGamePic.h difficultySelect.h win1.h win2.h deathFace.h
